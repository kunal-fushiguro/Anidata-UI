      ...
      <div className="flex justify-center items-center h-full w-full lg:flex-row flex-col pt-4">
        <div className="lg:w-[50%] lg:h-[100%] w-full h-[50%] flex justify-center items-center flex-col p-6 lg:p-12">
          ...
          <div className="text-lg text-center text-gray-600 leading-relaxed">
            ...
            data for developers, hobbyists, and anime enthusiasts. With access
            to a vast collection of anime information, you can integrate
            detailed anime data into your projects, apps, or websites
            effortlessly. Anidata’s API is designed for simplicity, allowing you
            to search, filter, and retrieve anime data with ease. Start building
            your anime-powered project today, no strings attached!
          </div>
